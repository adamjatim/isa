...
<body class="flex flex-col min-h-screen">
  ...
  <!-- footer -->
  <footer class="shadow bg-gray-900 mt-4 bottom-0">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <span class="block text-sm text-center text-gray-400">© 2023 <a href="/" class="hover:underline">waroeng Kopi</a>. All Rights Reserved.</span>
    </div>
  </footer>
